    ...
    <div className='p-4 bg-white rounded-md shadow-xl'>
        <div className='flex flex-col gap-y-4'>
            ...
            <div className='border flex flex-col items-center justify-center gap-y-3 p-4 rounded-md'>
                ...
                <Link to="/jobs/search"
        className="flex w-[60%] md:w-[30%] hover:underline  p-2 outline outline-1 items-center justify-center gap-x-2 outline-blue-500 font-semibold text-blue-500 hover:border-blue-500 border-[1px] border-transparent duration-150 rounded-full hover:bg-blue-50">
          Search jobs
        </Link>
            </div>
        </div>
