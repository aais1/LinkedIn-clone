        ...
        <div className='py-2 flex justify-between gap-x-2'>
            ...
            <img src="logo.png"
             ...
             <div className='flex gap-x-8'>
                ...
                <HeaderItem Icon={BsFillPeopleFill} color="gray" title="My Network"/>
                <HeaderItem Icon={BsFillHandbagFill} color="gray" title="Jobs"/>
                <HeaderItem Icon={IoChatbubbleEllipses} color="gray" title="Messaging"/>
